...
# Stage 3 palette — orange background, blue foreground, Nvidia green road
COLORS = np.array([
    [240, 130,  30],   # background — orange
...
def main():
    ...
    ap.add_argument("--out", default="orin_trt_int8.mp4",
    ...
    win_title = "Orin demo — PyTorch (top) vs TensorRT INT8 (bottom)"
    ...
    while n_frames is None or i < n_frames:
        ...
        overlay_stats(trt_panel, "TensorRT INT8 (after)",
